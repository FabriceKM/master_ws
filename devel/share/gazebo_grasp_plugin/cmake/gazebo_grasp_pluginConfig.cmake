...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_grasp_plugin_SOURCE_PREFIX /home/kmf/master_ws/src/gazebo-pkgs/gazebo_grasp_plugin)
  set(gazebo_grasp_plugin_DEVEL_PREFIX /home/kmf/master_ws/devel)
  ...
  set(gazebo_grasp_plugin_INSTALL_PREFIX /home/kmf/master_ws/install)
...
if(NOT "/home/kmf/master_ws/src/gazebo-pkgs/gazebo_grasp_plugin/include;/home/kmf/master_ws/build/gazebo-pkgs/gazebo_grasp_plugin/.. " STREQUAL " ")
  set(gazebo_grasp_plugin_INCLUDE_DIRS "")
  set(_include_dirs "/home/kmf/master_ws/src/gazebo-pkgs/gazebo_grasp_plugin/include;/home/kmf/master_ws/build/gazebo-pkgs/gazebo_grasp_plugin/..")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_grasp_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kmf/master_ws/src/gazebo-pkgs/gazebo_grasp_plugin/${idir}'.  ${_report}")
    endif()
