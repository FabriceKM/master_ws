...
class ColorFilter(object):
    ...
    def camera_callback(self, data):
        ...
        """
            All the hsv values that we detect in our image that are beyond these interval, are not gonna 
        ...
        # Here we overlap the cv_image with the same cv_image with respect to the mask we have just created
