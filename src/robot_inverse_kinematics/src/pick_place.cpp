...
{
    move_gripper.setJointValueTarget("finger_right_joint", 0.044);
    move_gripper.move();
}
...
void addCollisionObject(moveit::planning_interface::PlanningSceneInterface& planning_scene_interface)
{
    ...
    // /* The header.frame_id represents the reference frame from which the pose of the object is calculated */
...
// 
    ...
    // /*
    //     The orientation = 1.0 means that the object has the same orientation as the 
    //     'collision_objects[3].header.frame_id = "world"' which corresponds to the world frame in this case
    // */
